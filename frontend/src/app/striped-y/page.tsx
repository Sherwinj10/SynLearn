    ...
    <div className="min-h-screen pb-20" style={{ background: "var(--bg)", fontFamily: "var(--sans)" }}>
      ...
      <header style={{ background: "var(--surface)", borderBottom: "1px solid var(--border)", padding: "16px 24px", display: "flex", justifyContent: "space-between", alignItems: "center", position: "sticky", top: 0, zIndex: 100 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <div>
            <h1 style={{ fontFamily: "var(--display)", fontSize: "1.4rem", fontWeight: 700, margin: 0 }}>CleftMap Pro</h1>
      ...
      <div style={{ maxWidth: 1100, margin: "24px auto", padding: "0 24px", display: "flex", flexDirection: "column", gap: 24 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24, alignItems: "start" }}>
          ...
          <div className="card" style={{ padding: 24 }}>
            <h2 style={{ fontSize: "1rem", fontWeight: 700, marginBottom: 16, borderBottom: "1px solid var(--border)", paddingBottom: 12 }}>Anatomical Diagram</h2>
            <div style={{ fontSize: "0.8rem", color: "var(--text-muted)", textAlign: "center", marginBottom: 16, background: "var(--surface-2)", padding: 8, borderRadius: 6 }}>
              Click any numbered segment → select status below
            </div>
            ...
            <div style={{ marginTop: 24, padding: 16, background: "var(--surface-2)", borderRadius: 8, border: "1px solid var(--border)" }}>
              <h3 style={{ fontSize: "0.85rem", fontWeight: 700, color: "var(--text)", marginBottom: 4 }}>Set Status for Segment</h3>
              ...
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                {[
                  ...
                  <button 
                    ...
                    style={{
                      flex: 1, minWidth: "45%", padding: "8px 12px", borderRadius: 6, fontSize: "0.8rem", fontWeight: 600,
            ...
            {/* VPD Selector */}
            <div style={{ marginTop: 16, padding: 16, background: "var(--surface-2)", borderRadius: 8, border: "1px solid var(--border)" }}>
              <h3 style={{ fontSize: "0.85rem", fontWeight: 700, color: "var(--text)", marginBottom: 4 }}>VP Competence</h3>
              <p style={{ fontSize: "0.75rem", color: "var(--text-muted)", marginBottom: 12 }}>Assessed via dotted line to Pharynx circle (Seg 12)</p>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
                {[
                  ...
                  <button 
                    ...
                    onClick={() => setVpd(b.id)}
                    style={{
                      padding: "8px 12px", borderRadius: 6, fontSize: "0.75rem", fontWeight: 600,
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
            ...
            <div className="card" style={{ padding: 24 }}>
              <h2 style={{ fontSize: "1rem", fontWeight: 700, marginBottom: 16, borderBottom: "1px solid var(--border)", paddingBottom: 12 }}>Auto-Classification</h2>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                    <div style={{ background: "var(--surface-2)", padding: 12, borderRadius: 8, border: "1px solid var(--border)" }}>
                      <div style={{ fontSize: "0.7rem", color: "var(--text-muted)", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: 4 }}>Cleft Type</div>
                      <div style={{ fontSize: "0.9rem", fontWeight: 700, color: "var(--cyan)" }}>{classif.type}</div>
                      <div style={{ fontSize: "0.75rem", color: "var(--text-muted)", marginTop: 4 }}>{classif.detail || "—"}</div>
                    </div>
                    <div style={{ background: "var(--surface-2)", padding: 12, borderRadius: 8, border: "1px solid var(--border)" }}>
                      <div style={{ fontSize: "0.7rem", color: "var(--text-muted)", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: 4 }}>Laterality</div>
                      <div style={{ fontSize: "0.9rem", fontWeight: 700 }}>{classif.lat}</div>
                    </div>
                    <div style={{ background: "var(--surface-2)", padding: 12, borderRadius: 8, border: "1px solid var(--border)" }}>
                      <div style={{ fontSize: "0.7rem", color: "var(--text-muted)", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: 4 }}>Severity</div>
                      <div style={{ fontSize: "0.9rem", fontWeight: 700 }}>{classif.sev}</div>
                      <div style={{ fontSize: "0.75rem", color: "var(--text-muted)", marginTop: 4 }}>{classif.aff} segment(s) affected</div>
                    </div>
                    <div style={{ background: "var(--surface-2)", padding: 12, borderRadius: 8, border: "1px solid var(--border)" }}>
                      <div style={{ fontSize: "0.7rem", color: "var(--text-muted)", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: 4 }}>Repair Status</div>
                      <div style={{ fontSize: "0.9rem", fontWeight: 700 }}>{classif.repStatus}</div>
                    </div>
                  </div>
                  
                  <div style={{ background: "var(--surface)", border: "1px solid var(--border)", padding: 16, borderRadius: 8, display: "flex", alignItems: "center", gap: 12 }}>
                    <div style={{ fontSize: "0.85rem", fontWeight: 700 }}>LAHSAL:</div>
                    <div style={{ fontFamily: "var(--mono)", fontSize: "1.1rem", letterSpacing: "0.2em", fontWeight: 600, color: "var(--cyan)" }}>{lahsal}</div>
                  </div>
                </div>
              )}
            </div>
            ...
            <div className="card" style={{ padding: 24 }}>
              <h2 style={{ fontSize: "1rem", fontWeight: 700, marginBottom: 16, borderBottom: "1px solid var(--border)", paddingBottom: 12 }}>Clinical Summary</h2>
              ...
              {!anySet ? (
                ...
                <div style={{ fontSize: "0.85rem", lineHeight: 1.6, color: "var(--text)" }}>
                  <p><b>Diagnosis:</b> {classif.type} — {classif.lat}.</p>
                  <p><b>Severity:</b> {classif.sev} ({classif.aff} segment[s]).</p>
                  <p><b>Repair Status:</b> {classif.repStatus}.</p>
                  <p><b>LAHSAL:</b> <code style={{ background: "var(--surface-2)", padding: "2px 6px", borderRadius: 4, fontFamily: "var(--mono)" }}>{lahsal}</code></p>
                  {vpd && <p><b>VP Competence:</b> <span style={{ fontWeight: 700, color: "var(--text)" }}>{VPD_LABELS[vpd]}</span></p>}
                  
                  <div style={{ marginTop: 16, paddingTop: 16, borderTop: "1px dashed var(--border)" }}>
                    <b>SLP Implications:</b> {implications.length ? implications.join('; ') : 'Comprehensive evaluation recommended'}.
                  </div>
                </div>
              )}
            </div>
